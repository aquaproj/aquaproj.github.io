...
```console
$ aqua i -l
INFO[0000] create a symbolic link                        aqua_version=0.7.16 link_file=/Users/shunsuke-suzuki/.aqua/bin/tfmigrator new=aqua-proxy program=aqua
```
...
```console
$ tfmigrator -v
INFO[0000] download and unarchive the package            aqua_version=0.7.16 package_name=tfmigrator/cli package_version=v0.2.1 program=aqua registry=standard
