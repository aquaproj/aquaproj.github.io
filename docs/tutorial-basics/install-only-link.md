...
```console
$ aqua i -l
INFO[0000] create a symbolic link                        aqua_version=0.8.12 link_file=/home/foo/.aqua/bin/tfmigrator new=aqua-proxy program=aqua
```
...
```console
$ tfmigrator -v
INFO[0000] download and unarchive the package            aqua_version=0.8.12 package_name=tfmigrator/cli package_version=v0.2.1 program=aqua registry=standard
